...
import { Input, Checkbox, DatePicker, AutoComplete, Select, Upload } from 'antd' //adjust depending on your usage
import BraftEditor from 'braft-editor'; //add or remove depending on your usage
import moment from 'moment'; //add or remove depending on your usage
import 'braft-editor/dist/index.css' //add only if you are using braft-editor

const {render, renderUpload, validate, getOptions} = LizardReduxForm;
